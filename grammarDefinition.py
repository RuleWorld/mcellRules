from pyparsing import Word, Suppress, Optional, alphanums, Group, ZeroOrMore, Keyword, Literal, \
                      ...
                      quotedString, LineEnd, StringEnd, restOfLine, delimitedList, dictOf
...
hashed_section = (hashsymbol + Group(OneOrMore(name) + section_enclosure_))
...
other_sections = Group(name + section_enclosure_)
...
statementGrammar = ZeroOrMore(Suppress(other_sections) |  Suppress(hashed_section)  | statement)
